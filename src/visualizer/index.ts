...
import type { AnalysisResult, KnowledgeGraph, OutputOptions } from "../types/index.js";

export async function renderOutput(result: AnalysisResult, options: OutputOptions, kg?: KnowledgeGraph): Promise<string> {
  ...
  switch (format) {
    ...
    case "html": { const html = renderInteractiveHTML(result, kg); return outputPath ? writeFile(outputPath, html) : html; }
    default: throw new Error("Unsupported format: " + format);
  }
}

export { renderInteractiveHTML } from "./html.js";
